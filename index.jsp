...
<table border="0" height="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td valign="top" bgcolor="#003366">      <table border="0" cellpadding="0" cellspacing="0" >
...
<tr valign="top">
<td>
<p align="center"><img src="logo.gif" width="100" height="110" alt="Mercury Tours"><br>	  </p>
<table border="2" cellspacing="0" cellpadding="2" align="center" bordercolor="#000000" >
<tr class=mouseOut onMouseOut="changeStyle(this, 'mouseOut')" onMouseOver="changeStyle(this, 'mouseOver')">
<td width="20" height="19"></a></td>
<td  width="80" height="19" bgcolor="#FFC455" ><font color="#000000"><a href="mercurywelcome.php"  >Home</a></font></td>
</tr>
<tr class=mouseOut onMouseOut="changeStyle(this, 'mouseOut')" onMouseOver="changeStyle(this, 'mouseOver')">
<td width="20" height="19"></a></td>
<td  width="80" height="19" bgcolor="#FFC455"><a href="mercuryreservation.php" >Flights</a></td></tr>

<tr class=mouseOut onMouseOut="changeStyle(this, 'mouseOut')" onMouseOver="changeStyle(this, 'mouseOver')">
<td width="20" height="19"></a></td>
<td  width="80" height="19" bgcolor="#FFC455" ><a href="mercuryunderconst.php" >Hotels</a></td>
</tr>
<tr class=mouseOut onMouseOut="changeStyle(this, 'mouseOut')" onMouseOver="changeStyle(this, 'mouseOver')">
<td width="20" height="19"></a></td>
<td  width="80" height="19" bgcolor="#FFC455"><font color="#000000"><a href="mercuryunderconst.php" >Car Rentals</a></font></td>
</tr>
<tr class=mouseOut onMouseOut="changeStyle(this, 'mouseOut')" onMouseOver="changeStyle(this, 'mouseOver')">
<td width="20" height="19"></a></td>
<td width="80" height="19" bgcolor="#FFC455"><a href="mercurycruise.php">Cruises</a></td>
</tr>
<tr class=mouseOut onMouseOut="changeStyle(this, 'mouseOut')" onMouseOver="changeStyle(this, 'mouseOver')">
<td width="20" height="19"></a></td>

<td  width="80" height="19" bgcolor="#FFC455"><a href="mercuryunderconst.php" >Destinations</a></td>
</tr>
<tr class=mouseOut onMouseOut="changeStyle(this, 'mouseOut')" onMouseOver="changeStyle(this, 'mouseOver')">
<td width="20" height="19"></a></td>
<td  width="80" height="19" bgcolor="#FFC455" height="18"><a href="mercuryunderconst.php">Vacations</a></td>
</table>
<p align="center"><img src="html.gif" width="100" height="61" border="0">
<font face="Arial, Helvetica, sans-serif" color=white size="1"><u>Use Java Version</u></font></p>
<p align="center"><img src="boxad1.gif" width="88" height="78"></p>
</tr>
</table>
...
<!--AD REGION START-->
<img src="banner2.gif" width="488" height="63" border="0" hspace="8" vspace="4">
...
<!--HEADER REGION START-->
<table  border="1" bordercolor="#000000" cellpadding="0" cellspacing="0" height=" 16" background =" black">
  <tr>
...
<table width="492" border="0" cellspacing="0" cellpadding="0">
  <tr> 
    <td><img src="mast_register.gif" width="492" height="30"></td>
  </tr>
  <tr> 
    ...
    <td> 
	  ...
	  you must be open-minded and resourceful! This is certanley an interesting world, but you'll mostly find yourself blazing new trails in order to get shit done.
		...
		********hopefully i'll start here and get a perfect score**************
		check commit with deployment</font>
  ...
  <tr> 
    <td> 
      <form method="post" action="mercurycreate_account.php" >
	<input type=hidden name=mercury value=process>
        <table cellpadding="2" border=0 width="100%">
          <tr bgcolor=#CCCCCC> 
            <td colspan=2><font face="ARIAL, HELVETICA" size="2"><font color=white size=-1> 
              <b>&#160;&#160;<font color="#FFFFFF"><font face="ARIAL, HELVETICA" size="2" color="#000000">Contact 
              Information</font></font></b></font></font></td>
          ...
          <tr bgcolor="#CCCCCC"> 
            <td colspan="2"><font face="ARIAL, HELVETICA" size="2"><font color=white size=-1><b>&#160;&#160;<font color="#003399"><font face="ARIAL, HELVETICA" size="2" color="#000000">Mailing 
              Information</font></font></b></font></font></td>
          </tr>

          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" size="2"><b>Address:</b></font></td>
            <td> 
          ...
          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" size="2"><b>City:</b></font></td>
            <td> 
              <input maxlength=60 name="city" size="15">
            </td>
          </tr>
          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" size="2"><b>State/Province:</b></font></td>
          ...
          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" size="2"><b>Postal 
              Code:</b></font></td>
            <td> 
          ...
          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" size="2"><b>Country:</b></font></td>
            <td> 
              <select name="country" size="1">
                ...
                <option value="236">ARUBA </option>
                <option value="5">ASHMORE AND CARTIER ISLANDS </option>
                ...
                <option value="13">BAKER ISLAND </option>
                <option value="14">BANGLADESH </option>
                <option value="15">BARBADOS </option>
                <option value="16">BASSA DE INDIA </option>
                <option value="241">BELARUS </option>
                ...
                <option value="40">CLIPPERTON ISLAND </option>
                ...
                <option value="46">CORAL SEA ISLANDS </option>
                ...
                <option value="237">FALKLAND ISLANDS </option>
                ...
                <option value="68">FRENCH SOUTHERN AND ANTARCTIC LANDS </option>

                <option value="69">GABON </option>
                <option value="262">GAMBIA, THE </option>
                ...
                <option value="103">JOHNSTON ATOLL </option>
                <option value="104">JORDAN </option>
                <option value="105">JUAN DE NOVA ISLAND </option>
                <option value="244">KAZAKHSTAN </option>
                <option value="107">KENYA </option>

                <option value="108">KINGMAN REEF </option>
                <option value="109">KIRIBATI </option>
                <option value="259">KOREA, DEMOCRATIC PEOPLE'S REPUBLIC OF </option>
                <option value="260">KOREA, REPUBLIC OF </option>
                ...
                <option value="127">MAN, ISLE OF </option>
                ...
                <option value="266">MICRONESIA </option>
                <option value="133">MIDWAY ISLANDS </option>
                ...
                <option value="143">NAVASSA ISLAND </option>
                ...
                <option value="256">RUSSIA </option>
                ...
                <option value="263">SOMALIA </option>
                <option value="188">SOUTH AFRICA </option>
                <option value="211">SOVIET UNION </option>
                <option value="190">SPAIN </option>
                <option value="191">SPRATLY ISLANDS </option>

                <option value="192">SRI LANKA </option>
                <option value="174">ST. HELENA </option>
                <option value="173">ST. KITTS AND NEVIS </option>
                <option value="175">ST. LUCIA </option>
                <option value="176">ST. PIERRE AND MIQUELON </option>
                <option value="177">ST. VINCENT AND THE GRENADINES </option>
                ...
                <option value="205">TROMELIN ISLAND </option>
                ...
                <option value="225">WEST BANK </option>
          ...
          <tr bgcolor=#CCCCCC> 
            <td colspan=2> <font face="Arial, Helvetica, sans-serif" helvetica="helvetica" size="2"><font color=white><b>&#160;&#160;<font color="#000000">User 
              Information </font> </b></font></font></td>
          ...
          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" color=red size="2"><b>Password:</b></font></td>
          ...
          <tr> 
            <td align=right><font face="Arial, Helvetica, sans-serif" color=red size="2"><b>Confirm 
              Password: </b></font></td>
            <td> 
          ...
          <tr> 
            <td colspan="2" align=CENTER> &nbsp;&nbsp;<input type=image name="register" src="submit.gif" width="60" height="23" border="0"></td>
          </tr>
        </table>
      </form>
    </td>
